...
namespace Blackberry {
    ...
    // static void NormalizeAABB(BlVec3& min, BlVec3& max) {
    ...
    //         BlVec3 min1 = t1.Position - t1.Scale * 0.5f;
    //         BlVec3 max1 = t1.Position + t1.Scale * 0.5f;
    //         // BlVec3 min1 = t1.Position;
    //         // BlVec3 max1 = t1.Position - t1.Scale;
    //         NormalizeAABB(min1, max1);
    // 
    //         BlVec3 min2 = t2.Position - t2.Scale * 0.5f;
    //         BlVec3 max2 = t2.Position + t2.Scale * 0.5f;
    //         // BlVec3 min2 = t2.Position;
    //         // BlVec3 max2 = t2.Position - t2.Scale;
    ...
    //             BlVec3 acceleration = rb.ForceAccumulator / BlVec3(rb.Mass);
    // 
